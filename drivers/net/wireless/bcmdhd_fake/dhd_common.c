...
#ifdef CONFIG_BCMDHD_FAKE_FW_PATH
	strncpy(fw_path, CONFIG_BCMDHD_FAKE_FW_PATH, MOD_PARAM_PATHLEN-1);
#else
	fw_path[0] = '\0';
#endif
#ifdef CONFIG_BCMDHD_FAKE_NVRAM_PATH
	strncpy(nv_path, CONFIG_BCMDHD_FAKE_NVRAM_PATH, MOD_PARAM_PATHLEN-1);
#else
	nv_path[0] = '\0';
#endif
}
