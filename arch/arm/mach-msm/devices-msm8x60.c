...
static struct msm_bus_vectors grp3d_nominal_high_vectors[] = {
	{
		...
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab = 0,
#ifdef CONFIG_MSM_KGSL_3D_GPUOC_MAX
...
static struct msm_bus_vectors grp2d0_nominal_vectors[] = {
	{
		...
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab = 0,
#ifdef CONFIG_MSM_KGSL_2D_GPUOC_MAX
		.ib = KGSL_CONVERT_TO_MBPS(1300),
#else
		.ib = KGSL_CONVERT_TO_MBPS(990),
#endif
...
#endif
#ifdef CONFIG_MSM_KGSL_3D_GPUOC_NORM
		{
			.gpu_freq = 300000000,
			.bus_freq = 4,
			.io_fraction = 0,
...
#endif
#ifdef CONFIG_MSM_KGSL_3D_GPUOC_STOCK
		{
			.gpu_freq = 266667000,
			.bus_freq = 4,
			.io_fraction = 0,
	...
	.pwrlevel = {
		{
			...
			.gpu_freq = 266667000,
#endif
#ifdef CONFIG_MSM_KGSL_2D_GPUOC_NORM
			.gpu_freq = 228571000,
#endif
#ifdef CONFIG_MSM_KGSL_2D_GPUOC_STOCK
			.gpu_freq = 200000000,
#endif
			.bus_freq = 2,
		},
